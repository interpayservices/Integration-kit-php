    ...
    <div class="new">
        <form action="" method="post">
            <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="gradientbg">
                ...
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">APP ID: </td>
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="APP_ID" class="signuptextfield" value="<?php echo PG_APP_ID; ?>" autocomplete="off" />
                    </td>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="MERCHANTNAME" class="signuptextfield" value="Demo" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="ORDER_ID" class="signuptextfield" value="<?php echo 'avxID'.date('dmyHi')?>" autocomplete="off" />
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_EMAIL" class="signuptextfield" value="user@gmail.com" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
